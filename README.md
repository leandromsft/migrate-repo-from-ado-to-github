...
The `.github/workflows/inventory-report.yml` workflow manages the automated generation and analysis of Azure DevOps inventory to support migration planning to GitHub.
